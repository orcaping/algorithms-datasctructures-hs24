 ...
 * Version: Sun Oct  6 13:57:13 CEST 2024
 */

package ex04.baseline.task01;
...
public class AVLTreeJUnitTest {
  ...
  public void test11MultipleSameKeys() {
    ...
    Collection<AVLTreeImpl<Integer, String>.Node> nodes = new LinkedList<>();
  ...
  public void test22StressTest() {
    ...
    Map<Integer, Integer> keyCounters = new Hashtable<>();
    // fill the Tree
  ...
  private static void verify(Collection<AVLTreeImpl<Integer, String>.Node> nodes, String[] expected) {
    int i = 0;
    for (AVLTreeImpl<Integer, String>.Node node: nodes) {
