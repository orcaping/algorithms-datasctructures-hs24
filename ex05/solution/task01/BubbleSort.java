...
public class BubbleSort {
  ...
  public static <T extends Comparable<? super T>> void bubbleSort2(T[] sequence) {
    boolean bubbled = false;
    T temp;
    int unsortedSize = sequence.length;
    do {
      bubbled = false;
...
$ java -Xint -Xms5m -Xmx5m ex05/solution/task01/BubbleSort
...
> do
>  java -Xint -Xms5m -Xmx5m ex05/solution/task01/BubbleSort $i
> done
Too many elements, not printing to stdout.
Bubble sort 1...done.
Bubble sort 2...done.
Too many elements, not printing to stdout.
Time bubble sort 1 :  Array-Size:   1,024       Time:   251.9 ms
Time bubble sort 2 :  Array-Size:   1,024       Time:   134.6 ms
Too many elements, not printing to stdout.
Bubble sort 1...done.
Bubble sort 2...done.
Too many elements, not printing to stdout.
Time bubble sort 1 :  Array-Size:   2,048       Time:   971.9 ms
Time bubble sort 2 :  Array-Size:   2,048       Time:   490.1 ms
Too many elements, not printing to stdout.
Bubble sort 1...done.
Bubble sort 2...done.
Too many elements, not printing to stdout.
Time bubble sort 1 :  Array-Size:   4,096       Time: 3,705.2 ms
Time bubble sort 2 :  Array-Size:   4,096       Time: 1,987.8 ms
